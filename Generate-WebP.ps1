...
# Location: C:\Repos\Cornwall Wedding Photography\Generate-WebP.ps1

# Configuration
$ProjectRoot = "C:\Repos\Cornwall Wedding Photography"
...
$jpegFiles = Get-ChildItem -Path $JpegSource -Recurse -Include *.jpg, *.jpeg, *.JPG, *.JPEG
...
foreach ($jpeg in $jpegFiles) {
    ...
    try {
        ...
        magick convert $jpeg.FullName -quality $Quality $webpFullPath
